...
```
mvn -f ports/experimental/kafka-streams/pom.xml compile          # compile (downloads deps online)
mvn -f ports/experimental/kafka-streams/pom.xml exec:java         # print topology.describe() (no broker needed)
```
