 ...
 * The {@link DurabilityProfile} chooses the journal (memory, Postgres, Cassandra) purely by
...
public final class PekkoSystem implements AutoCloseable {
  ...
  /** Boots with an explicit configuration (tests that layer their own overrides on a profile). */
