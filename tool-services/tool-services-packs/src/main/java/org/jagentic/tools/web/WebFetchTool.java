...
/**
 * Tool the agent can call to GET a URL and receive parsed text + discovered links + content
 * type. Routes through {@link Fetcher} so robots.txt + user-agent + max-page-size are all
 * honoured. Suitable as a general-purpose "look at this URL" tool exposed to the LLM.
 */
public final class WebFetchTool implements OneShotTool {
